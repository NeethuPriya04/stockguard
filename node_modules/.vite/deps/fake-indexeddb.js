...
var FDBCursor = class {
  constructor(source, range, direction = "next", request, keyOnly = false) {
    ...
    __publicField(this, "_keyOnly", false);
...
var BinarySearchTree = class {
  ...
  constructor(keysAreUnique) {
    __publicField(this, "_numTombstones", 0);
    __publicField(this, "_numNodes", 0);
...
var FDBTransaction = class extends FakeEventTarget_default {
  constructor(storeNames, mode, durability, db) {
    ...
    __publicField(this, "_openRequest", null);
    __publicField(this, "error", null);
    __publicField(this, "onabort", null);
    __publicField(this, "oncomplete", null);
    __publicField(this, "onerror", null);
    __publicField(this, "_prioritizedListeners", /* @__PURE__ */ new Map());
    __publicField(this, "_requests", []);
    __publicField(this, "_createdIndexes", /* @__PURE__ */ new Set());
    __publicField(this, "_createdObjectStores", /* @__PURE__ */ new Set());
    ...
    for (const type of prioritizedListenerTypes) {
      this.addEventListener(type, () => {
        var _a;
        (_a = this._prioritizedListeners.get(type)) == null ? void 0 : _a();
      });
    }
  }
...
var ObjectStore = class {
  constructor(rawDatabase, name, keyPath, autoIncrement) {
    __publicField(this, "deleted", false);
    __publicField(this, "records", new RecordStore_default(true));
...
var FDBDatabase = class extends FakeEventTarget_default {
  ...
  transaction(storeNames, mode, options) {
    ...
    const durability = (options == null ? void 0 : options.durability) ?? "default";
...
var FDBFactory = class {
  constructor() {
    ...
    __publicField(this, "_connectionQueues", /* @__PURE__ */ new Map());
  }
...
function forceCloseDatabase(db) {
  closeConnection_default(db, true);
}

// node_modules/fake-indexeddb/build/esm/index.js
var esm_default = fakeIndexedDB_default;
export {
  FDBCursor_default as IDBCursor,
  FDBCursorWithValue_default as IDBCursorWithValue,
  FDBDatabase_default as IDBDatabase,
  FDBFactory_default as IDBFactory,
  FDBIndex_default as IDBIndex,
  FDBKeyRange_default as IDBKeyRange,
  FDBObjectStore_default as IDBObjectStore,
  FDBOpenDBRequest_default as IDBOpenDBRequest,
  FDBRecord_default as IDBRecord,
  FDBRequest_default as IDBRequest,
  FDBTransaction_default as IDBTransaction,
  FDBVersionChangeEvent_default as IDBVersionChangeEvent,
  esm_default as default,
  forceCloseDatabase,
  fakeIndexedDB_default as indexedDB
};
//# sourceMappingURL=fake-indexeddb.js.map
